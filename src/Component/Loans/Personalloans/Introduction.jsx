...
import personalimg from "../../../assets/loans/personalloan.jpeg"
        ...
        <div className="mb-5">
            ...
            <Container fluid>
                <Breadcrumb className="breadcrumsvss">
                    ...
                    <Breadcrumb.Item active>Personal Loan</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                        ...
                        <div className="sidebar">
                            <Accordion defaultActiveKey="0">
                                <Accordion.Item eventKey="0">
                                    <Accordion.Header>Personal Loan Overview</Accordion.Header>
                                    <Accordion.Body>
