    ...
    return (
      <div className="emi-calculator">
        ...
        <section className="sidecontent">
          ...
          <Row className="mt-4">
            <Col lg={12}>
              <div className="chart-container" style={{ height: '320px', marginTop: '20px', border: '1px solid #eee', borderRadius: '8px', padding: '20px' }}>
                <h6 className="text-center mb-3">Graphical View</h6>
