...
//                 <p style={{ marginTop: '60px' }}>Managing your Business finances effectively is key to long-term growth and success. Our <b>Business Loan EMI Calculator</b> helps you calculate the monthly EMI (Equated Monthly Installment) payments based on your loan amount, interest rate, and tenure.</p>
//                 <h3 className="mb-4">How It Works:</h3>
//                 <ul className="itro-sxssaaasx mb-5">
//                     <li><b>Enter the Loan Amount:</b> The total sum you plan to borrow for your business needs.</li>
//                     <li><b>Select the Interest Rate:</b> The rate at which the bank or financial institution will charge interest on your loan.</li>
//                     <li><b>Choose the Loan Tenure:</b> The number of months (or years) over which you wish to repay the loan.</li>
//                 </ul>
...
const EmiCalculatorData = () => {
  ...
  const chartData = [
    { name: 'Principal Amount', value: loanAmount > 0 ? loanAmount : 0, color: '#1A5F7A' },
    { name: 'Total Interest', value: totalInterest > 0 ? totalInterest : 0, color: '#F7B32D' }
  ];
  ...
  return (
    <div className="business-loan-emi-calculator">
      <section className="sidecontent">
        <h3>Business Loan EMI Calculator</h3>
        <p style={{ marginTop: '60px' }}>
          Strategically plan your business financing with our Business Loan EMI Calculator. 
          Understand your monthly installments, total interest, and total payment 
          to make informed financial decisions for your business growth.
        </p>
        <Row style={{ justifyContent: 'space-evenly' }}>
          <Col lg={5}>
            <div>
              <form className="form-calculator">
                <div className="form-group">
                  <label htmlFor="amount">Business Loan Amount:</label>
                  <div className="input-group mb-4">
                    <input
                      type="text"
                      className="form-control"
                      ...
                      placeholder="Enter business loan amount"
                    />
                ...
                <div className="form-group">
                  <label htmlFor="interest">Business Loan Interest Rate Per Year:</label>
                  <div className="input-group mb-4">
                    <input
                      type="text"
                      className="form-control"
                ...
                <div className="form-group">
                  <label htmlFor="tenure">Business Loan Tenure:</label>
                  <div className="input-group mb-4">
                    <input
                      type="text"
                      className="form-control"
          ...
          <Col lg={5}>
            <div className="emi-details">
              <div className="emi-details-head">
                <h6>Your Business Loan EMI Details</h6>
              </div>
              <div className="emi-details-box">
        ...
        <Row className="mt-4">
          <Col lg={12}>
            <div className="chart-container" style={{ height: '320px', marginTop: '20px', border: '1px solid #eee', borderRadius: '8px', padding: '20px', marginBottom:'40px' }}>
              <h6 className="text-center mb-3">Business Loan Graphical View</h6>
              ...
              <div className="chart-legend text-center">
                <div className="d-flex justify-content-center mt-2">
                  <div className="mx-4">
                    <span style={{ display: 'inline-block', width: '16px', height: '16px', backgroundColor: '#1A5F7A', marginRight: '5px', verticalAlign: 'middle' }}></span>
                    <span style={{ fontWeight: 'bold' }}>Principal: ₹{loanAmount.toFixed(2)}</span>
                  </div>
                  <div className="mx-4">
                    <span style={{ display: 'inline-block', width: '16px', height: '16px', backgroundColor: '#F7B32D', marginRight: '5px', verticalAlign: 'middle' }}></span>
