...
//                 <p style={{ marginTop: '60px' }}>Managing your Home finances effectively is key to long-term growth and success. Our Loan Against Property EMI Calculator helps you calculate the monthly EMI (Equated Monthly Installment) payments based on your loan amount, interest rate, and tenure.</p>
...
const EmiCalculatorData = () => {
  ...
  const chartData = [
    { name: 'Principal Amount', value: loanAmount > 0 ? loanAmount : 0, color: '#8B4513' },
    { name: 'Total Interest', value: totalInterest > 0 ? totalInterest : 0, color: '#CD853F' }
  ];
  ...
  return (
    <div className="loan-against-property-emi-calculator">
      <section className="sidecontent">
        <h3>Loan Against Property (LAP) EMI Calculator</h3>
        <p style={{ marginTop: '60px' }}>
          Unlock the potential of your property with our Loan Against Property EMI Calculator. 
          Easily estimate your monthly installments, total interest, and total payment 
          by leveraging the value of your real estate asset.
        </p>
        <Row style={{ justifyContent: 'space-evenly' }}>
          <Col lg={5}>
            <div>
              <form className="form-calculator">
                <div className="form-group">
                  <label htmlFor="amount">Loan Amount Against Property:</label>
                  <div className="input-group mb-4">
                    <input
                      type="text"
                      className="form-control"
                ...
                <div className="form-group">
                  <label htmlFor="interest">Loan Interest Rate Per Year:</label>
                  <div className="input-group mb-4">
                    <input
                      type="text"
                      className="form-control"
                      ...
                      placeholder="Enter interest rate (e.g. 11.5)"
                    />
                    <div className="input-group-append">
                      <div className="input-group-text">%</div>
                    </div>
          ...
          <Col lg={5}>
            <div className="emi-details">
              <div className="emi-details-head">
                <h6>Your Loan Against Property EMI Details</h6>
              </div>
              <div className="emi-details-box">
        ...
        <Row className="mt-4">
          <Col lg={12}>
            <div className="chart-container" style={{ height: '320px', marginTop: '20px', border: '1px solid #eee', borderRadius: '8px', padding: '20px', marginBottom:'40px' }}>
              <h6 className="text-center mb-3">Loan Against Property Graphical View</h6>
              ...
              <div className="chart-legend text-center">
                <div className="d-flex justify-content-center mt-2">
                  <div className="mx-4">
                    <span style={{ display: 'inline-block', width: '16px', height: '16px', backgroundColor: '#8B4513', marginRight: '5px', verticalAlign: 'middle' }}></span>
                    <span style={{ fontWeight: 'bold' }}>Principal: ₹{loanAmount.toFixed(2)}</span>
                  </div>
                  <div className="mx-4">
                    <span style={{ display: 'inline-block', width: '16px', height: '16px', backgroundColor: '#CD853F', marginRight: '5px', verticalAlign: 'middle' }}></span>
